...
from moma_safety.tiago.grippers import PALGripper, RobotiqGripper2F_140, RobotiqGripper2F_85
from moma_safety.tiago.head import TiagoHead
from moma_safety.tiago.tiago_mobile_base import TiagoBaseVelocityControl
from moma_safety.tiago.tiago_torso import TiagoTorso
from moma_safety.tiago.tiago_arms import TiagoArms
...
class Tiago:
    ...
    def __init__(self,
        ...
        self.arms = {
            'right': TiagoArms(right_arm_enabled, side='right', torso=self.torso, torso_enabled=False, gripper_type=right_gripper_type),
            'left': TiagoArms(left_arm_enabled, side='left', torso=self.torso, torso_enabled=False, gripper_type=left_gripper_type),
        }
    ...
    def reset(self, reset_arms=True, reset_pose=None, allowed_delay_scale=6.0, delay_scale_factor=1.5, wait_user=True, force_z_th=None):
