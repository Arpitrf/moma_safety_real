...
from moma_safety.tiago.utils.transformations import euler_to_quat, quat_to_euler, add_angles, quat_to_rmat
...
class TiagoArms:
    ...
    def write(self, joint_goal, duration_scale, threshold=5e-3, delay_scale_factor=1.0, force_z_th=None, teleop=False):
        counter = 0
    ...
    def step(self, action, delay_scale_factor=1.0, force_z_th=None, teleop=False):
        if self.arm_enabled:
            ...
            if joint_goal is not None:
                ...
                self.write(joint_goal, duration_scale, delay_scale_factor=delay_scale_factor, force_z_th=force_z_th, teleop=teleop)
