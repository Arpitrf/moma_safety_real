...
class GraspLossFTDetector():
    def __init__(self, env):  
        '''MODEL LOADING'''
        num_class = 1
        experiment_dir = "/home/pal/arpit/Pointnet_Pointnet2_pytorch/pointnet2/log/classification/run_open_drawer_grasp_label_2400"
    ...
    def predict(self, action, threshold=0.5, object_name=None):
        points = self.points
