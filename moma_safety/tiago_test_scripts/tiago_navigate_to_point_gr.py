...
def main(args):
    ...
    move_to_skill = NavigateToPointSkill(
    ...
    query= args.query #"Navigate towards the blue table"
    # query="Navigate towards the blue marker"
    move_to_skill.step(
        env=env,
        rgb=rgb,
        depth=depth,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--query', type=str, default='Navigate towards the blue table')
