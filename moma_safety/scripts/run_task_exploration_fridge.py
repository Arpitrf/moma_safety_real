...
class TaskExploration:
    def __init__(self, env):
        ...
        with open('resources/human_tracking_outputs/arpit_open_fridge_temp.json') as f:
    ...
    def cleanup_post_manip(self, object_name):
        ...
        reset_joint_pos = RP.PREGRASP_FRIDGE
    ...
    def expl(self, subtask_idx):
        ...
        if "grasp" in subtask["description"].lower():
            ...
            if subtask["action"].lower() == "navigating":
                ...
                # TODO: set robot pose if next action is grasp and robot is not holding anything
                ...
                # # remove later
                # current_subtask_retval = {"subtask_success": True, "actions": []}
...
def main():
    ...
    # rospy.sleep(2)
    # # reset_joint_pos = RP.HOME_MEDIUM_TORSO
    # reset_joint_pos = RP.PREGRASP_FRIDGE
